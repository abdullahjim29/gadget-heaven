  ...
  return (
    <section className="flex items-center h-full sm:p-16 dark:bg-gray-50 dark:text-gray-800">
        <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8 space-y-8 text-center ">
          ...
          <p className="text-2xl font-semibold md:text-4xl">Sorry, we couldn't find this page.</p>
			<p className="mt-4 mb-8 dark:text-gray-600 w-full lg:w-4/12">But dont worry, you can find plenty of other things on our homepage.</p>
          <Link to='/'
