...
const Banner = () => {
  return (
    <div className="bg-[#9538E2] container mx-auto py-8 pb-34 text-center space-y-6 rounded-b-2xl mb-44 md:mb-10 lg:mb-80">
      ...
      <div className="md:w-3/6 md:hidden lg:block absolute border-2 border-white rounded-2xl backdrop-blur-2xl p-4 md:-bottom-80 md:left-40 lg:-bottom-40 lg:left-80">
